...
import { useImageExtract } from "@/components/tiptap-ui/image-extract-button"
import {
...
const ImageActionGroup: React.FC = () => {
  ...
  const { canExtract, handleExtract, label: extractLabel, Icon: extractIcon } = useImageExtract({
    hideWhenUnavailable: true,
  })
